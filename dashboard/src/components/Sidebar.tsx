...
export function Sidebar({ active, onChange }: SidebarProps) {
    return (
        <aside className="fixed left-0 top-16 h-[calc(100vh-64px)] flex flex-col z-40 bg-[#11161D] border-r border-[#2A3442] w-20 hover:w-64 transition-all duration-300 group overflow-hidden">
