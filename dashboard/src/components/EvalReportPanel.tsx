    ...
    return (
        ...
        >
                ...
                {report.checks.map((check) => {
                    ...
                    return (
                        <div
                            ...
                            style={{
                                background: check.pass ? "transparent" : "rgba(255,106,61,0.03)",
                            }}
                        >
                            {/* Pass/Fail icon */}
                            <span
            ...
            {report.fixInstructions && (
                ...
                >
                    <div className="text-[9px] font-bold uppercase tracking-widest mb-1.5" style={{ color: "#FF6A3D" }}>
                        FIX INSTRUCTIONS
                    </div>
                    <p
            ...
            {deployedUrl && (
                ...
                >
                    <span className="material-symbols-outlined text-[12px]" style={{ color: "rgba(215,255,47,0.4)" }}>
                        link
                    </span>
                    <a
                        href={deployedUrl}
